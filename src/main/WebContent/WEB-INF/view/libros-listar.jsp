...
<c:forEach var="item" items="${libros}" >
	<tr> 
		...
		<td>
			<button type="button" onclick="window.location.href='/ismac-libreria-matutino-web/libros/findOne?opcion=1&idLibro=${item.idLibro}';return false;">Actualiar</button>
			<button type="button" onclick="window.location.href='/ismac-libreria-matutino-web/libros/findOne?opcion=2&idLibro=${item.idLibro}';return false;">Borrar</button>
